...
const storedItems = ["item1", "item2", "item3"] as const;
      ...
      <div className="space-y-12">
        <section className="space-y-3">
          <h2 className="font-[family-name:var(--font-heading)] text-2xl font-medium leading-snug">
            {t("sections.anonymous.title")}
          </h2>
          <p className="text-base leading-relaxed text-foreground/90">
            {t("sections.anonymous.body")}
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="font-[family-name:var(--font-heading)] text-2xl font-medium leading-snug">
            {t("sections.stored.title")}
          </h2>
          <p className="text-base leading-relaxed text-foreground/90">
            {t("sections.stored.body")}
          </p>
